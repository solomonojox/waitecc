                ...
                <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
                        <div className="lg:col-span-2 space-y-6">
                            ...
                            <div className="pt-6">
                                <a href="https://forms.gle/yDjwCxPE2hBTahAo6" target="_blank" rel="noopener noreferrer" className="w-full py-4 px-8 bg-primary hover:bg-primary/85 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transform transition-all duration-300 hover:-translate-y-1 flex items-center justify-center">
