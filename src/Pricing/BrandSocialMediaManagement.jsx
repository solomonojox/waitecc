...
const plans = [
    {
        ...
        features: [
            ...
            "Basic audience interaction tracking",
            "Monthly content performance overview",
            "Standard post templates and design support",
        ],
    ...
    },
    {
        ...
        features: [
            ...
            "Bi-weekly content performance reviews",
        ],
        bgColor: "bg-purple-200",
        buttonColor: "bg-purple-600 hover:bg-purple-700",
    },
    {
        ...
        features: [
            ...
            "Full-service brand development, including messaging & identity",
            "Influencer collaborations & outreach",
            "AI-driven trend analysis & market forecasting",
            "Personalized campaign execution & strategy adjustments",
    ...
    },
    {
        ...
        duration: "",
        features: [
            "Tailored branding solutions based on your specific goals",
            "Exclusive access to advanced AI-powered marketing tools",
            "Hands-on support from a dedicated brand strategist",
            "Specialized brand positioning & growth strategies",
            "Priority access to influencer and media partnerships",
        ],
            ...
            <div className="flex justify-center flex-wrap gap-4 px-4 lg:px-0 py-8">
                {plans.map((plan, index) => (
                    <motion.div
                        ...
                        className={`rounded-md shadow-md lg:w-[280px] overflow-hidden hover:border-blue-500 bg-white`}
                    >
                            ...
                            <ul className="text-left space-y-2 mb-6">
                                {plan.features.map((feature, idx) => (
                                    <li key={idx} className="flex items-center">
                                        <FaCircleCheck className="mr-2 text-purple-600 w-[10%]" />
...
export default BrandSocialMediaManagement;
